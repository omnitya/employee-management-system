...
public class EmployeeControllerIntegrationTest {
	...
	public void testGetManager() {
		Employee employee = restTemplate.getForObject(getRootUrl() + "/employees/1/manager", Employee.class);
		System.out.println(employee.getFirstName());
		assertNotNull(employee);
	}
	...
	public void testGetReportees() {
		...
		ResponseEntity<String> response = restTemplate.exchange(getRootUrl() + "/employees/1/reportees", HttpMethod.GET,
				entity, String.class);
	...
	public void testCreateEmployee() {
		...
		employee.setEmailId("omnitya@hotmail.com");
		employee.setFirstName("omnitya");
